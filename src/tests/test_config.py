...
class ConfigModuleTests(SimpleTestCase):
    ...
    @override_settings(REST_FLEX_FIELDS={"WILDCARD_EXPAND_VALUES": ["all"]})
    ...
    @override_settings(REST_FLEX_FIELDS={"WILDCARD_VALUES": ["legacy"]})
    ...
    @override_settings(REST_FLEX_FIELDS={"WILDCARD_VALUES": "not-a-list"})
    ...
    @override_settings(REST_FLEX_FIELDS={"RECURSIVE_EXPANSION_PERMITTED": "yes"})
