...
If you already have a custom serializer base class, you can instead mix in `FlexFieldsSerializerMixin`.
...
The full list of supported settings is documented in [Advanced Topics](advanced.md#customization).
